...
write_csv(
  elo_out,
  file.path("CBB", "data", "CBB_Offense_Defense_Elo_2026.csv")
)
...
write_csv(
  predictions,
  file.path("CBB", "data", "CBB_OffDef_Elo_Future_Game_Predictions.csv")
)
print(predictions)
...
# WRITE CSV
# ===============================
#write_csv(final_df, file.path("data", "CBB_Projected_Records_SOS_2026.csv"))
print(final_df)
```
...
# -------------------------------
write_csv(elo_ranking, file.path("data", "CBB_Elo_2026.csv"))
print(elo_ranking)
